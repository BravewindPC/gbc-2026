...
export const Navbar = () => {
    ...
    return(
        <div className=" z-10 relative w-full h-[80px] sm:h-[110px]">
            <Image src="/bg.png" alt="bg" layout="fill" objectFit="cover" />
            <Image src="/Header.png" alt="bg" layout="fill" objectFit="cover" />
            <div className="absolute left-2 flex items-center h-full">
                <div className=" sm:hidden cursor-pointer">
                    <Link href="/">
                        <Image src="/Logo.png" width={65} height={65} alt="logo" objectFit="contain"/>
                    </Link>
                </div>
                <div className=" hidden sm:inline-block cursor-pointer">
                    <Link href="/">
                        <Image src="/Logo.png" width={95} height={95} alt="logo" objectFit="contain"/>
                    </Link>
                </div>
            ...
            <div className="absolute md:hidden right-6 flex items-center h-full">
                <button onClick={()=>shownav(true)} className=" flex justify-center items-center w-[41px] h-[41px] bg-templateBlue  rounded-full">
                    <div className=" w-[25px] h-[25px] bg-templateBlue rounded-full">
                        <Image src="/hamburger.svg" alt="bg" width={80} height={80} objectFit="cover" />
                    </div>
                </button>
            </div>

            {isnav && (
                <div className="md:hidden fixed z-20 w-full h-screen bg-black bg-opacity-50">
                    ...
                    <Image src="/bgh.png" alt="bg" layout="fill" objectFit="cover"/>
                    ...
                    <div className="mt-12 z-10 ">
                        <Image src="/UBT_White.png" className="animated-navbar-component" width={150} height={150} alt="logo" objectFit="contain"/>
                    </div>
                    </div>
                </div>
            )}
