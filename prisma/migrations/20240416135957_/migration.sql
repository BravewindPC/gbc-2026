/*
  ...
  - The values [TERRA,HMO,PATRA] on the enum `Organization` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Organization_new" AS ENUM ('HIMATIKA', 'TPB_FMIPA', 'KMPN', 'HIMATEK', 'HMS', 'HMASTRON', 'HIMA_TG', 'GEA', 'TPB_FTMD', 'HMH_SELVA', 'IMMG', 'HME', 'HMIF', 'TPB_SF', 'TPB_FTI', 'TPB_FITB', 'TPB_FTTM', 'HMFT', 'HMO_TRITON', 'KMKL', 'HMME', 'SITH_S', 'HMTL', 'HMT', 'TPB_STEI', 'TPB_SBM', 'TPB_FTSL', 'MTI', 'HMTM_PATRA', 'IMA_G', 'AMISCA', 'HMF', 'HMRH', 'HMPPL', 'SITH_R');
